...
msg = {
	'ar': {
                ...
                'commons-file-now-available' : u'الملف الآن متوفر في ويكيميديا كومنز.',
	},
        'de': {
                'commons-file-now-available' : u'Datei ist jetzt auf Wikimedia Commons verfügbar.',
	},
        'en': {
        ...
        'eo': {
                'commons-file-now-available' : u'Dosiero nun estas havebla en la Wikimedia-Komunejo.',
	},
        'fa': {
        ...
        'ia': {
                'commons-file-now-available' : u'Le file es ora disponibile in Wikimedia Commons.',
	},
        'it': {
                'commons-file-now-available' : u'L\'immagine è adesso disponibile su Wikimedia Commons.',
	},
        'kk': {
                'commons-file-now-available' : u'Файлды енді Wikimedia Ортаққорынан қатынауға болады.',
	},
        'lt': {
                'commons-file-now-available' : u'Failas įkeltas į Wikimedia Commons projektą.',
	},
        'nds-nl': {
                'commons-file-now-available' : u'Disse ofbeelding is beschikbaor op Wikimedia Commons.',
	},
        'nl': {
                'commons-file-moved' : u'[[:File:%(localfile)s|Bestand]] is verplaatst naar [[:commons:File:%(commonsfile)s|commons]].',
                'commons-file-now-available' : u'Dit bestand staat nu op [[w:nl:Wikimedia Commons|Wikimedia Commons]].',
	},
        'pl': {
                'commons-file-moved' : u'[[:File:%(localfile)s|Plik]] przeniesiona do [[:commons:File:%(commonsfile)s|commons]].',
                'commons-file-now-available' : u'Plik jest teraz dostępny na Wikimedia Commons.',
	},
        'pt': {
                'commons-file-now-available' : u'Arquivo está agora na Wikimedia Commons.',
	},
	'qqq': {
        ...
        'ru': {
                ...
                'commons-file-now-available' : u'Файл теперь доступен на Викискладе.',
	},
        'sr': {
                'commons-file-now-available' : u'Слика је сада доступна и на Викимедија Остави.',
	},
        'zh': {

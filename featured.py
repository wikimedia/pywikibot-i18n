...
msg = {
	...
	# Author: Y-M D
	'br': {
		'featured-featured': u'Bot : %(page)s zo ur pennad eus an dibab',
		'featured-former': u'Bot : %(page)s zo bet ur pennad eus an dibab',
	...
	'fi': {
		'featured-featured': u'Botti: %(page)s on suositeltu artikkeli',
		'featured-former': u'Botti: %(page)s on entinen suositeltu artikkeli',
	...
	'frr': {
		...
		'featured-former': u'Bot: %(page)s wiar ans en auer a miaten guden artiikel',
		'featured-good': u'Bot: %(page)s as en guden artiikel',
		'featured-list': u'Bot: %(page)s as en wäärdag list',
	},
	# Author: Toliño
	'gl': {
	...
	# Author: Farras
	'id': {
		'featured-featured': u'Bot: %(page)s adalah artikel pilihan',
	...
	'lb': {
		...
		'featured-list': u'Bot: %(page)s ass eng Qualitéitslëscht',
	},
	'lt': {
	...
	# Author: Anakmalaysia
	'ms': {
		'featured-featured': u'Bot: %(page)s merupakan rencana pilihan',
	...
	'nds-nl': {
		...
		'featured-good': u'Bot: %(page)s is n goed artikel',
	...
	'nl': {
		...
		'featured-list': u'Robot: %(page)s is een uitgelichte lijst',
	},
	'nn': {
	...
	'ro': {
		...
		'featured-former': u'Robot: %(page)s este un fost articol de calitate',
	...
	# Author: Minh Nguyen
	'vi': {
		'featured-featured': u'Bot: %(page)s là một bài viết chọn lọc',
		'featured-former': u'Bot: %(page)s từng là một bài viết chọn lọc',

...
msg = {
    ...
    # Author: Als-Holder
    'als': {
        'reflinks-autogen': u'automatisch aagleit',
        'reflinks-comment': u'Automatisch generierte Titel',
        'reflinks-msg': u'Bot: Korräkt Referänzformat (lueg [[%(manual)s]])',
    },
    'ar': {
    ...
    'eo': {
        ...
        'reflinks-msg': u'Roboto: Konverto de plataj referencoj, nomigo de referencoj por eviti duoblaĵojn, vidu [[%(manual)s|manlibron]]',
    },
    # Author: Fitoschido
    # Author: Macofe
    'es': {
    ...
    # Author: Subi
    'eu': {
        'reflinks-autogen': u'automatikoki sortua',
    },
    # Author: Alirezaaa
    # Author: Reza1615
    'fa': {
    ...
    # Author: Jagwar
    'mg': {
        'reflinks-autogen': u'namboarina ho azy',
        'reflinks-comment': u'Lohateny namboarina ho azy',
        'reflinks-msg': u'Rôbô: Mamadika ny tsiahy ratsy soratra, famafana ny verindroa amin\'ny alalan\'ny fampiasana tsiahy misy anarana, jereo ny [[%(manual)s|fanazavana]].',
    },

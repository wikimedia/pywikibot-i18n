...
msg = {
        ...
        'nl': {
                'template-changing': u'Bot: vervangen {{PLURAL:%(num)d|sjabloon|sjablonen}}: %(list)s',
                'template-removing': u'Bot: verwijderen {{PLURAL:%(num)d|sjabloon|sjablonen}}: %(list)s',
                'template-substituting': u'Bot: substitueren {{PLURAL:%(num)d|sjabloon|sjablonen}}: %(list)s',
        },
        'no': {

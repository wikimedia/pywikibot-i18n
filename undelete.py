...
msg = {
    ...
    'en': {
        ...
        'undelete-linked-pages': u'Bot: Undeleting all pages linked from %(page)s',
    },
    # Author: Unicodesnowman
    'qqq': {
        'undelete-from-file': u'Edit summary when the bot undeletes a list of pages.',
    ...
    # Author: Reza1615
    'fa': {
        'undelete-from-file': u'ربات: احیای فهرستی از صفحات',
        'undelete-images': u'ربات: احیای همهٔ تصاویر صفحهٔ %(page)s',
        'undelete-linked-pages': u'ربات: احیای تمام صفحه‌هایی که در %(page)s پیوند شده‌اند',
    },
    # Author: Gomoko
    'fr': {
        'undelete-from-file': u'Robot: Annulation de la suppression d’une liste de pages',
    ...
    # Author: Gianfranco
    'it': {
        'undelete-from-file': u'Bot: Ripristinare un elenco di pagine',
    ...
    'ksh': {
        ...
        'undelete-images': u'Bot: Ben de Belder vun dä Sigg %(page)s wider aam holle.',
        'undelete-linked-pages': u'Bot: Ben alle Sigge aam wider holle, woh vun %(page)s drop jelengk es.',
    },
    # Author: Robby
    'lb': {
        'undelete-from-file': u'Bot: Restauratioun vun enger Lëscht vu Säiten',
    ...
    'nl': {
        ...
        'undelete-images': u'Robot: alle afbeeldingen op pagina %(page)s teruggeplaatst',
        'undelete-linked-pages': u'Robot: alle pagina\'s gekoppeld vanaf %(page)s teruggeplaatst',
    },
    # Author: Gaute
    # Author: Xqt
    'nn': {
        'undelete-from-file': u'Robot: Atterreiser ei liste med sider',
        'undelete-images': u'Robot: Atterreiser alle bilder på sida %(page)s',
        'undelete-linked-pages': u'Robot: Atterreiser alle sider som er lenkja frå %(page)s',
    },
    # Author: Helland
    'no': {
        'undelete-from-file': u'Gjenoppretter en liste med sider',
    ...
    'zh': {
        'undelete-from-file': u'机器人：取消删除一列表的页面',
        'undelete-images': u'机器人：取消删除%(page)s页面上的所有图片',
        'undelete-linked-pages': u'机器人：取消删除所有从%(page)s链接的页面',
    },
};

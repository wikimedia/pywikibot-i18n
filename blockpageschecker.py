...
msg = {
    ...
    'da': {
        'blockpageschecker-summary': u'Robot: Sletning af forældet skabelon',
    },
    # Author: Metalhead64
    'de': {
        'blockpageschecker-summary': u'Bot: Lösche veraltete Vorlage',
    },
    # Author: Gorizon
    'diq': {
    ...
    # Author: Murma174
    'frr': {
        'blockpageschecker-summary': u'Bot: Ualang föörlaagen stregen',
    },
    # Author: Toliño
    'gl': {
    ...
    'mk': {
        'blockpageschecker-summary': u'Бот: Брише застарен шаблон',
    },
    # Author: Praveenp
    'ml': {
        'blockpageschecker-summary': u'യന്ത്രം: കാലഹരണപ്പെട്ട ഫലകം മായ്ക്കുന്നു',
    },
    # Author: Aurora
    'ms': {
    ...
    'uk': {
        'blockpageschecker-summary': u'Бот: видалення застарілих шаблонів',
    },
    # Author: Minh Nguyen
    'vi': {

...
msg = {
	...
	# Author: ChrisPtDe
	'frp': {
		'redirect-fix-double': u'Bot : rèpâre redirèccion dobla a %(to)s',
	...
	'gl': {
		...
		'redirect-broken-redirect-template': u'{{db-r1}}',
		'redirect-remove-broken': u'[[WP:CSD#G8|G8]]: [[Wikipedia:Redirect|Redirección]] cara a unha páxina eliminada ou en branco',
	},
	# Author: Xqt
	# Author: Als-Holder
	'gsw': {
	...
	'ia': {
		...
		'redirect-remove-loop': u'[[WP:CSD#G8|G8]]: Le destination del [[Wikipedia:Redirect|redirection]] forma un circulo de redirectiones',
		'redirect-broken-redirect-template': u'{{db-r1}}',
		'redirect-remove-broken': u'[[WP:CSD#G8|G8]]: [[Wikipedia:Redirect|Redirection]] a un pagina delite o non existente',
	},
	# Author: IvanLanin
	'id': {
	...
	'ne': {
		...
		'redirect-remove-loop': u'[[WP:CSD#G8|G8]]: [[Wikipedia:Redirect|रिडाइरेक्ट]] निसाना पृष्ठ रिडाइरेक्ट भएर घुमिरहन्छ',
		'redirect-broken-redirect-template': u'{{db-r1}}',
		'redirect-remove-broken': u'[[WP:CSD#G8|G8]]: [[Wikipedia:Redirect|रिडाइरेक्ट]]  लाइ मेटिएको वा हुदै नभएको पृष्ठमा पठाएको',
	},
	# Author: Siebrand
	# Author: Krinkle
	'nl': {
	...
	'sv': {
		...
		'redirect-remove-loop': u'!!FUZZY!![[WP:CSD#G8|G8]]: [http://sv.wikipedia.org/wiki/Wikipedia:Omdirigeringar Omdirigerar] målet som utgör en omdirigeringsloop',
	...
	'tr': {
		...
		'redirect-broken-redirect-template': u'{{db-rl}}',
	...
	# Author: Hydra
	'zh-hans': {
		'redirect-fix-double': u'机器人:修正双重重定向 → %(to)s',
	},
	'zh-yue': {

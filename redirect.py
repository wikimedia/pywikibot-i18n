...
msg = {
	...
	'uk': {
		...
		'redirect-remove-loop': u'[[ВП:КШВ#Перенаправлення|П]]: [[Довідка:Перенаправлення|Перенаправлення]] формує петлю перенаправлень',
		'redirect-remove-broken': u'[[ВП:КШВ#Перенаправлення|П1]]: [[Довідка:Перенаправлення|Перенаправлення]] на вилучену або неіснуючу сторінку',
	},
	'war': {

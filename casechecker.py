...
msg = {
    ...
    # Author: Gwenn-Ael
    'br': {
        'casechecker-delete-reason': u'Bukañ a rae an adkas-se war %(target)s',
        'casechecker-delete-summary': u'Robot : An adkas-mañ zo ennañ lizherennoù heñvel eus al lizherenneg kirillek ha latin en e ditl.',
        'casechecker-rename': u'Robot : adenvel e tirenneg kemmesk',
        'casechecker-replacement-linklist': u'%(source)s→%(target)s',
        'casechecker-replacement-summary': u'Robot : kemmoù  tirenneg  :',
    },
    # Author: Edinwiki
    'bs': {
    ...
    # Author: C.R.
    'nap': {
        'casechecker-delete-reason': u'Stu redirect è ausato pe\' puntà a %(target)s',
        'casechecker-delete-summary': u'Bot: stu redirect cuntente dit\' \'o titolo lettere \'a l\'alfabeto cirillico e latino eguale',
        'casechecker-rename': u'Bot: rinommeno p\'avé maiuscole/minuscole mmescate',
        'casechecker-replacement-linklist': u'%(source)s→%(target)s',
    ...
    'ne': {
        ...
        'casechecker-delete-summary': u'बोट: यस अनुप्रेषणमा शिर्षकमा उस्तै देखिने सिरिलिक र ल्याटिन वर्णहरू छन्',
        'casechecker-rename': u'बोट: मिश्रित वर्ण पूनर्नामाङ्कन',
        'casechecker-replacement-linklist': u'%(source)s→%(target)s',
    ...
    'nl': {
        ...
        'casechecker-delete-summary': u'Robot: deze doorverwijzing bevat identiek uitziende Cyrillische en Latijnse letters in de naam',
        'casechecker-rename': u'Robot: hoofdletters en kleine letters gewijzigd',
        'casechecker-replacement-linklist': u'%(source)s→%(target)s',
        'casechecker-replacement-summary': u'Robot: wijzigingen in kleine letters en hoofdletters:',
    },
    # Author: Cocu
    'no': {
    ...
    'uk': {
        'casechecker-delete-reason': u'Це перенаправлення використано для вказування на %(target)s',
        'casechecker-delete-summary': u'Бот: Це перенаправлення містить суміш латинських та кириличних літер у назві',
        'casechecker-rename': u'Бот: мішаний випадок перейменування',
        'casechecker-replacement-linklist': u'%(source)s→%(target)s',
        'casechecker-replacement-summary': u'Бот: Випадки заміни:',
    },
    # Author: Minh Nguyen
    'vi': {
        'casechecker-delete-reason': u'Trang này từng đổi hướng đến %(target)s',
        'casechecker-delete-summary': u'Bot: Tên trang đổi hướng này có chữ Kirin và Latinh y hệt nhau',
        'casechecker-rename': u'Bot: Đổi tên hỗn hợp chữ hoa/thường',
        'casechecker-replacement-linklist': u'%(source)s→%(target)s',
        'casechecker-replacement-summary': u'Bot: Thay thế chữ hoa/thường:',
    },
    # Author: פוילישער
    'yi': {
    ...
    'zh': {
        ...
        'casechecker-delete-summary': u'机器人：此重定向的标题包含看上去相同的西里尔字母与拉丁字母',

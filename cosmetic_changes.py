...
msg = {
	...
	'commons': {
		'cosmetic_changes-standalone': u'Bot: [[Commons talk:Tools/pywiki file description cleanup|desc page fmt]]',
		'cosmetic_changes-append': u'; [[Commons talk:Tools/pywiki file description cleanup|desc page fmt]]',
	},
	'cs': {
	...
	'nl': {
		'cosmetic_changes-standalone': u'Bot: cosmetische wijzigingen',

...
msg = {
	...
	'ckb': {
		...
		'category-was-moved': u'ڕۆبۆت: پۆل گوازرایەوە بۆ [[:پۆل:%(newcat)s|%(title)s]]',
	},
	'crh': {
	...
	'als': {
		...
		'category-was-moved': u'Bötli: Kategori isch no [[:Kategorie:%(newcat)s|%(title)s]] verschobe wore',
	},
	'gu': {

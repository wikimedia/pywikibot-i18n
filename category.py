...
msg = {
    ...
    'bcc': {
        ...
        'category-also-in': u'(همچنین بی %(alsocat)s)',
        'category-changing': u'ربات: ٹ	گل داته بوت %(oldcat)s بی %(newcat)s',
    ...
    'bjn': {
        ...
        'category-renamed': u'Bot: Mamindahakan matan %s. Pamakai: %s',
        'category-replacing': u'Bot: Mangganti tumbung %(oldcat)s lawan %(newcat)s',
        'category-section-title': u'Raralatan bahari tungkaran bakas %(oldcat)s',
        'category-version-history': u'Robot: Manyimpan raralatan bahari bakas %(oldcat)s',
    ...
    'ca': {
        ...
        'category-listifying': u'Robot: llistant de %(fromcat)s ({{PLURAL:%(num)d|1 entrada|%(num)d entrades}})',
        ...
        'category-version-history': u'Robot: guardant l\'historial de versions dels %(oldcat)s previs',
    ...
    'eu': {
        ...
        'category-version-history': u'Errobota: Antzinako %(oldacat)s bertsio historiala gordetzen',
    ...
    'frr': {
        ...
        'category-section-title': u'Werjuunshistoore faan det ual %(oldcat)s',
        'category-version-history': u'Bot: Seekere werjuunshistoore faan det ual %(oldcat)s',
    ...
    'hy': {
        ...
        'category-renamed': u'Ռոբոտ․ Տեղափոխվել է %s֊ից։ Հեղինակներ՝ %s',
    ...
    'kk': {
        ...
        'category-changing': u'Бот: %(oldcat)s дегенді %(newcat)s дегенге өзгертті',
        'category-listifying': u'Бот: %(fromcat)s дегеннен (%(num)d буын) тізімдеді',
        'category-removing': u'Бот: %(oldcat)s дегеннен аластатты',
        'category-renamed': u'Бот: %s дегеннен жылжытты. Авторлары: %s.',
        'category-replacing': u'Bot:  %(oldcat)s дегеннен %(newcat)s дегенге санаттын өзгертті',
        'category-section-title': u'Беттің бұрыңғы %(oldcat)s тарихы',
        'category-strip-cfd-templates': u'Бот: Бітірген әрекеттер үшін CFD үлгілерін аластауда',
        'category-version-history': u'Бот: Бұрыңғы %(oldcat)s нұсқа тарихын сақтауда',
    ...
    'mai': {
        'category-was-moved': u'रोबोट: श्रेणी के हटा देल गेल अछि [[:Category:%(newcat)s|%(title)s]]',
    },
    # Author: StefanusRA
    # Author: Xqt
    'map-bms': {
    ...
    'nap': {
        ...
        'category-removing': u'Bot: Luvann\'a %(oldcat)s',
        'category-renamed': u'Bot: Spustata \'a %s. Auture: %s',
        'category-replacing': u'Bot: Rimpiazzanno categurìe %(oldcat)s cu %(newcat)s',
        'category-section-title': u'Cronologgia \'e primma %(oldcat)s',
        ...
        'category-was-moved': u'Bot: Categurìa spustat\'a [[:Category:%(newcat)s|%(title)s]]',
    },
    # Author: Slomox
    # Author: Xqt
    'nds': {
    ...
    'ne': {
        ...
        'category-listifying': u'बोट: %(fromcat)sबाट (%(num)d entries)मा सूचीकृत गर्दै',
        'category-removing': u'रोबोट: %(oldcat)sबाट हटाउँदै',
        'category-renamed': u'रोबोट: %sबाट सारियो। लेखकहरू: %s',
        'category-replacing': u'रोबोट: %(oldcat)s श्रेणलाई %(newcat)sसंग साट्दै',
        'category-section-title': u'%(oldcat)sको पृष्ठ इतिहास',
        ...
        'category-was-moved': u'रोबोट: श्रेणीलाई  [[:Category:%(newcat)s|%(title)s]]मा सारियो',
    },
    # Author: Eukesh
    'new': {
    ...
    'szl': {
        ...
        'category-changing': u'Robot: Pomjyńo %(oldcat)s do %(newcat)s',
        ...
        'category-version-history': u'Bot: Spamjyntańy gyszichty starych %(oldcat)s',

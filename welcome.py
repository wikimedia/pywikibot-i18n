...
msg = {
	...
	'ia': {
		...
		'welcome-updating': u'Robot: Actualisation del registro',
		'welcome-welcome': u'Benvenite!',
	},
	# Author: Farras
	'id': {
	...
	'ms': {
		'welcome-bad_username': u'Bot: Menambah nama pengguna yang perlu diperiksa',
	...
	# Author: Strainu
	'ro': {
		'welcome-bad_username': u'Robot: Adăugat un nume de utilizator care trebuie verificat',
	...
	# Author: Khutuck
	'tr': {
		'welcome-bad_username': u'Bot: Kullanıcı adını kontrol edilmesi gerekenlere ekliyor',
		'welcome-updating': u'Bot: Kayıt güncelleme',
	...
	# Author: Minh Nguyen
	'vi': {
		'welcome-bad_username': u'Bot: Thêm một tên người dùng cần được kiểm tra',
		'welcome-updating': u'Bot: Cập nhật nhật trình',

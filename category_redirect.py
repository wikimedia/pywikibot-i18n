...
msg = {
	...
	'es': {
		'category_redirect-change-category': u'Bot: moviendo páginas de categoría redirigida',
	...
	'fa': {
		'category_redirect-change-category': u'ربات:تغییر رده‌هایی که انتقال یافته‌اند',
	...
	'ksh': {
		'category_redirect-change-category': u'Bot: Sigk uß en ömjeleidt Saachjropp eruß jesammdt.',
	...
	'pl': {
		'category_redirect-change-category': u'Robot: Usuwa strony z przekierowanej kategorii',
	...
	'pt': {
		'category_redirect-change-category': u'Bot: movendo páginas de redirecionamentos de categorias',
		'category_redirect-add-template': u'Bot: adicionando a predefinição de redirecionamento de categoria',
		'category_redirect-fix-double': u'Robô: Corrigindo redirecionamento duplo',
		'category_redirect-comment': u'Bot de manutenção de categorias de redirecionamento',
		'category_redirect-edit-request-item': u'* %(title)s está em %(oldcat)s, que redireciona para %(newcat)s',
		'category_redirect-edit-request': u'As seguintes páginas protegidas foram detectadas como carecendo de actualizações de ligações de categorias: %(itemlist)s',
	},
	'pt-br': {
	...
	'sr-el': {
		'category_redirect-fix-double': u'Bot: ispravljanje dvostrukih preusmerenja',
	},
	'sv': {
	...
	'tr': {
		'category_redirect-fix-double': u'Bot değişikliği: Yönlendirmeye olan yönlendirme',
	},
	'tt': {
	...
	'vi': {
		'category_redirect-change-category': u'Robot: bỏ trang ra khỏi thể loại đổi hướng',
		'category_redirect-add-template': u'Robot: thêm bản mẫu đổi hướng thể loại để dễ bảo trì',
		'category_redirect-fix-double': u'Robot: sửa thể loại đổi hướng kép',
		'category_redirect-comment': u'Robot theo dõi thể loại đổi hướng',
